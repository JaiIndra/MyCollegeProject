...
$email= $_SESSION['e_id'];
//echo $email;
$q=mysqli_query($con,"select * from student  where  stu_id='18x41a1229');
...
{	
	...
	mysqli_query($action,"update student set name='$name',eid='$eid',password='$p',mob='$mobile',address='$address',department_id='$course',sem_id='$semester',
